...
return cljs.core._write(writer__4452__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_25438 = (self__.level + (1));
while(true){
if((i_25438 <= (new_level + (1)))){
(update[i_25438] = self__.header);

var G__25439 = (i_25438 + (1));
i_25438 = G__25439;
continue;
} else {
}
...
var i_25440 = (0);
while(true){
if((i_25440 <= self__.level)){
var links_25441 = (update[i_25440]).forward;
if(((links_25441[i_25440]) === x__$1)){
(links_25441[i_25440] = (x__$1.forward[i_25440]));

var G__25442 = (i_25440 + (1));
i_25440 = G__25442;
continue;
} else {
var G__25443 = (i_25440 + (1));
i_25440 = G__25443;
continue;
}
} else {
...
if(!((nx == null))){
var G__25445 = nx;
var G__25446 = (level__$1 - (1));
x = G__25445;
level__$1 = G__25446;
continue;
} else {
var G__25447 = x;
var G__25448 = (level__$1 - (1));
x = G__25447;
level__$1 = G__25448;
continue;
}
...
var G__25450 = nx;
var G__25451 = (level__$1 - (1));
x = G__25450;
level__$1 = G__25451;
continue;
} else {
var G__25452 = x;
var G__25453 = (level__$1 - (1));
x = G__25452;
level__$1 = G__25453;
continue;
}
...
return cljs.core._write(writer__4452__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3864__auto__,timeout__$1,me){
return (function (){
